  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        hhe: {
          ochre: "oklch(0.72 0.14 68)",
          crimson: "oklch(0.56 0.19 26)",
          sky: "oklch(0.65 0.13 222)",
          stone: "oklch(0.38 0.016 60)",
          cream: "oklch(0.93 0.018 82)",
          dark: "oklch(0.10 0.012 58)",
        },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: {
        xs: "0 1px 2px 0 rgba(0,0,0,0.05)",
        glow: "0 0 40px -8px oklch(0.56 0.19 26 / 0.4)",
        "glow-ochre": "0 0 40px -8px oklch(0.72 0.14 68 / 0.35)",
      },
      keyframes: {
